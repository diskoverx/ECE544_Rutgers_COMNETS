...
rp1 :: RouterPort(DEV veth2, IN_MAC ce:30:e3:04:fa:82, OUT_MAC 56:a0:77:bd:8d:35);

// veth3 to veth4 connection
rp2 :: RouterPort(DEV veth3, IN_MAC be:71:c6:a5:a4:2e, OUT_MAC ee:c7:96:b5:f2:07);

//veth5 to veth6 connection
rp3 :: RouterPort(DEV veth5, IN_MAC ae:2d:cd:b2:22:fb, OUT_MAC 1a:38:d5:ee:e9:ae);
